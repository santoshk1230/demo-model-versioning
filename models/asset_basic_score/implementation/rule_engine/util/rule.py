...
import datetime
import re
from util.name_match import get_similarity_class
...
tag_dict = {'ai01': 'Address Incomplete',
    ...
    'df02': 'Communication Platform Registration (Phone)',
    'df03': 'No Ecommerce registeration found (Phone)',
    'df04': 'UPI not found',
    'df05': 'No ITR found',
    'df06': 'Temporary Email',
    'df07': 'Registered on Risky Fintech',
                ...
                for rule_value in rules[rule]:
                    try:
                        if rule == "else":
                            ...
                            if rule in ["sequential_triggers"]:
