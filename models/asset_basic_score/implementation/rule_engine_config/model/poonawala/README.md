# Poonawalla – Asset Basic Score Configuration
...
### v1.0.0
Files (repo paths):
- models/asset_basic_score/implementation/rule_engine_config/config/poonawala/Poonawala_1_0_0.json
...
- Client Config Owner: Poonawalla DS Team

## Validation
- Smoke Test Payload Path: ____________________

## Rollback
- Revert to previous configuration or commit(s).
