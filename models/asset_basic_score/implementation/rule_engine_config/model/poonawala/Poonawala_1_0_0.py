...
class Poonawalla_1_0_0:
    ...
    def get_rules():
        rule_dict = {
            ...
            "is_phone_valid_score": {
                "input_phone_number":{},
                "is_phone_format_valid_decision":{}
            },
            "is_email_valid_score":{
                "input_email_id":{},
                "is_email_format_valid_decision":{}
            },
            "is_pan_valid_score":{
                "input_pan_number":{},
                "is_pan_format_valid_decision":{}
            },
        ...
        # pan_name_match_trigger_score 
        rule_dict["pan_name_match_trigger_score"]["input_name"]['null_check'] = [
            [0]
        ]
        ...
        rule_dict["pan_name_match_trigger_score"]["similarity_class"]["=="] = [
            [["0"], 0],
            [["1"], -50,{"pan_name_match1_tag":"nm03"}],
            [["2"], 0,{"pan_name_match2_tag":"nm06"}],
            [["3"], 10],
        ]
        ...
        # invalid_phone_tigger_score
        rule_dict["is_phone_valid_score"]["input_phone_number"]["null_check"] = [
            [0]
        ]
        rule_dict["is_phone_valid_score"]["is_phone_format_valid_decision"]["is_valid_mobile_format"] = [
            ['input_phone_number']
        ]
        rule_dict['is_phone_valid_score']['is_phone_format_valid_decision']['==']=[[true_vals, 0], [false_vals, 0,{'invalid_phone_tag_1':'df08'}]]
        rule_dict['is_phone_valid_score']['is_phone_format_valid_decision']['else']=[0]



        # invalid_pan_trigger_score
        rule_dict['is_pan_valid_score']['input_pan_number']['null_check']=[
            [0]
        ]
        rule_dict['is_pan_valid_score']['is_pan_format_valid_decision']["is_valid_pan_format"] = [
            ['input_pan_number']
        ]
        rule_dict['is_pan_valid_score']['is_pan_format_valid_decision']['==']=[[true_vals,0],[false_vals,0,{'invalid_pan_tag_1':'di10'}]]
        rule_dict['is_pan_valid_score']['is_pan_format_valid_decision']['else']=[0]

        # invalid_email_trigger_score
        rule_dict['is_email_valid_score']['input_email_id']['null_check']= [
            [0]
        ]
        rule_dict['is_email_valid_score']['is_email_format_valid_decision']["is_valid_email_format"] = [
            ['input_email_id']
        ]
        rule_dict['is_email_valid_score']['is_email_format_valid_decision']["=="] = [[true_vals,0],[false_vals,0,{'invalid_email_tag_1':'df06'}]]
        rule_dict['is_email_valid_score']['is_email_format_valid_decision']['else']= [0]
