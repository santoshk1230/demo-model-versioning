...
rule_dict = LARSONTUBRO_1_0_0.get_rules()
...
def test_larsontubro_with_enriched_data():
    payload = {
        "enriched_data": {
            "name_match_score": 82,
            "email_first_seen_year": 2018,
            "phone_email_first_seen_year": 2019,
            "phone_name_first_seen_year": 2018,
            "email_mapped_with_phone": 1,
            "digital_identity_score": 620,
            "phone_name_d_i_score": 220,
            "fintech_count": 6,
        ...
        "phone_vpa": {"upi": True, "name": "TEST LT"},
        "phone_intelligence": {"number_billing_type": "postpaid"},
        "age_on_network": {"date_aon": "2018-04-01"},
        "cdsl": {"cdsl": True},
        "gst": {"inactive_gst_count": 0},
        "mobile_uan": {"uan_available": True}
    }
